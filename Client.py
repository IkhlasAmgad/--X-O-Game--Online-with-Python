...
def clicked1():
    ...
    if(btn1['text'] == " "): 
        btn1['text'] = "x"
        value = "1" 
        s.send(value.encode("utf-8")) #Send the value to the client
...
btn1=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked1)
     #clicked1 is a function ,"black" is the X-O when they are pressed
btn1.grid(row=0,column=1)

btn2=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked2)
btn2.grid(row=0,column=2)

btn3=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked3)
btn3.grid(row=0,column=3)

btn4=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked4)
btn4.grid(row=1,column=1)

btn5=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked5)
btn5.grid(row=1,column=2)

btn6=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked6)
btn6.grid(row=1,column=3)

btn7=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked7)
btn7.grid(row=2,column=1)

btn8=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked8)
btn8.grid(row=2,column=2)

btn9=Button(wind,text=" ",bg="red",fg="black",width=3,height=1,font=('Hekvetic','15'),command=clicked9)
